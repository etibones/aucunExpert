...
/*---------------------------------Usager----------------------------------------------*/
DROP FUNCTION projets3.fusion_user_privilege() CASCADE ;
CREATE FUNCTION projets3.fusion_user_privilege() returns TABLE (cip varchar(8), nom text, prenom text, couriel text, privilege text) as $$
...
/*-------------------------------------------------------------------------------*/
drop view projets3.v_user;
CREATE VIEW projets3.v_user as SELECT * from fusion_user_privilege();
