...
/* Created on:     2018-06-26 10:42:21                          */
/*==============================================================*/
...
/*==============================================================*/
create  index RELATIONSHIP_7_FK on RESERVER (
OFF_CIP,
NOM_CAR,
ID_VILLE,
ID_CAMPUS,
...
alter table RESERVER
   add constraint FK_RESERVER_RELATIONS_USAGERS foreign key (CIP)
      references USAGERS (CIP)
      on delete restrict on update restrict;

alter table RESERVER
   add constraint FK_RESERVER_RELATIONS_OFFRES foreign key (OFF_CIP, NOM_CAR, ID_VILLE, ID_CAMPUS, ID_OFFRE)
