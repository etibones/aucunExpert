...
/* Created on:     2018-07-11 13:24:09                          */
/*==============================================================*/
...
create table RESERVER (
   ...
   constraint PK_RESERVER primary key (OFF_CIP, NOM_CAR, ID_VILLE, ID_CAMPUS, CIP, ID_OFFRE)
);
...
/*==============================================================*/
/* Index: STATUSUSAGER_FK                                       */
/*==============================================================*/
create  index STATUSUSAGER_FK on USAGERS (
ID_PRIVILEGE
);
...
alter table RESERVER
   add constraint FK_RESERVER_RESERVER2_OFFRES foreign key (OFF_CIP, NOM_CAR, ID_VILLE, ID_CAMPUS, ID_OFFRE)
      references OFFRES (CIP, NOM_CAR, ID_VILLE, ID_CAMPUS, ID_OFFRE)
      on delete restrict on update restrict;

alter table USAGERS
   add constraint FK_USAGERS_STATUSUSA_PRIVILEG foreign key (ID_PRIVILEGE)
